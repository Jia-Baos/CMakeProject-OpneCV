...
int main() {
    double t1 = countTime();
    MRF2D mrf;
    const string s1 = "D:/Code-VS/picture/test-data/tsukuba/tsukuba-imL.png";
    const string s2 = "D:/Code-VS/picture/test-data/tsukuba/tsukuba-imR.png";
    //const string s1 = "D:/Code-VS/picture/test-data/cones/im0.png";
    //const string s2 = "D:/Code-VS/picture/test-data/cones/im1.png";
